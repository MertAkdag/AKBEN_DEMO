...
/** Kuyumcu: Sipariş ürünleri */
const JEWELRY_PRODUCTS = [
  { id: 'jp1', name: 'Bilezik - 14 ayar', model: '14K', status: 'active', location: 'Stok', runtime: 0, createdAt: now, updatedAt: now, deletedAt: null },
  { id: 'jp2', name: 'Yüzük - Özel tasarım', model: '18K', status: 'active', location: 'Atölye', runtime: 0, createdAt: now, updatedAt: now, deletedAt: null },
  { id: 'jp3', name: 'Kolye ucu', model: '925 gümüş', status: 'active', location: 'Stok', runtime: 0, createdAt: now, updatedAt: now, deletedAt: null },
  { id: 'jp4', name: 'Küpe seti', model: '14K', status: 'active', location: 'Vitrin', runtime: 0, createdAt: now, updatedAt: now, deletedAt: null },
  { id: 'jp5', name: 'Kolye + Küpe set', model: '18K', status: 'active', location: 'Atölye', runtime: 0, createdAt: now, updatedAt: now, deletedAt: null },
];
