...
const MOCK_PRODUCTS: Product[] = [
  { id: 'p1', name: 'Has Örgü Bileklik', description: 'El işi has örgü, 14 ayar sarı altın.', categoryId: 'cat1', variantId: 'v1', brandId: 'b1', unitId: 'u2', pricePerUnit: 2850, featured: true, imageUrl: `${AKBEN_IMG}/akben_bileklik_1.png`, createdAt: now, updatedAt: now },
  { id: 'p2', name: 'İnce Çift Bileklik', description: 'Minimal çift bileklik seti.', categoryId: 'cat1', variantId: 'v1', brandId: 'b2', unitId: 'u1', pricePerUnit: 4200, featured: true, imageUrl: `${AKBEN_IMG}/akben_bileklik_2.png`, createdAt: now, updatedAt: now },
  { id: 'p3', name: 'Taşlı Kelepçe', description: 'Pırlanta taşlı kelepçe, 18 ayar.', categoryId: 'cat7', variantId: 'v2', brandId: 'b3', unitId: 'u1', pricePerUnit: 12500, featured: false, imageUrl: `${AKBEN_IMG}/akben_kelepce_4.png`, createdAt: now, updatedAt: now },
  { id: 'p4', name: 'Gümüş Bayan Bileklik', description: '925 ayar gümüş, oksitlenmeye karşı kaplama.', categoryId: 'cat1', variantId: 'v4', brandId: 'b2', unitId: 'u1', pricePerUnit: 890, featured: false, imageUrl: `${AKBEN_IMG}/akben_bileklik_3.png`, createdAt: now, updatedAt: now },
  { id: 'p5', name: 'Nişan Yüzüğü', description: 'Pırlanta taşlı, 18 ayar beyaz altın.', categoryId: 'cat2', variantId: 'v2', brandId: 'b3', unitId: 'u1', pricePerUnit: 18500, featured: true, imageUrl: `${AKBEN_IMG}/akben_yuzuk_1.png`, createdAt: now, updatedAt: now },
  { id: 'p6', name: 'Klasik Alyans', description: '14 ayar sarı altın, sade alyans.', categoryId: 'cat2', variantId: 'v1', brandId: 'b2', unitId: 'u1', pricePerUnit: 3200, featured: false, imageUrl: `${AKBEN_IMG}/akben_yuzuk_2.png`, createdAt: now, updatedAt: now },
  { id: 'p7', name: 'Zarif Yüzük', description: 'İnce taşlı yüzük, 18 ayar.', categoryId: 'cat2', variantId: 'v2', brandId: 'b1', unitId: 'u1', pricePerUnit: 4500, featured: false, imageUrl: `${AKBEN_IMG}/akben_yuzuk_3.png`, createdAt: now, updatedAt: now },
  { id: 'p8', name: 'Pırlanta Kelepçe', description: 'Tek taş pırlanta kelepçe, 14 ayar.', categoryId: 'cat7', variantId: 'v1', brandId: 'b3', unitId: 'u1', pricePerUnit: 9200, featured: true, imageUrl: `${AKBEN_IMG}/akben_kelepce_3.png`, createdAt: now, updatedAt: now },
  { id: 'p9', name: 'Kelepçe Model 6', description: 'Şık kelepçe, 925 gümüş.', categoryId: 'cat7', variantId: 'v4', brandId: 'b2', unitId: 'u1', pricePerUnit: 650, featured: false, imageUrl: `${AKBEN_IMG}/akben_kelepce_6.png`, createdAt: now, updatedAt: now },
  { id: 'p10', name: 'İnce Bileklik', description: 'İnce zincir bileklik, 14 ayar.', categoryId: 'cat1', variantId: 'v1', brandId: 'b1', unitId: 'u2', pricePerUnit: 2100, featured: false, imageUrl: `${AKBEN_IMG}/akben_bileklik_4.png`, createdAt: now, updatedAt: now },
  { id: 'p11', name: 'Pırlanta Küpe', description: 'Pırlanta taşlı küpe, 18 ayar.', categoryId: 'cat4', variantId: 'v2', brandId: 'b3', unitId: 'u1', pricePerUnit: 3800, featured: false, imageUrl: `${AKBEN_IMG}/akben_kupe_1.png`, createdAt: now, updatedAt: now },
  { id: 'p12', name: 'Küpe Seti', description: 'Çift küpe, 14 ayar.', categoryId: 'cat4', variantId: 'v1', brandId: 'b2', unitId: 'u1', pricePerUnit: 2100, featured: false, imageUrl: `${AKBEN_IMG}/akben_kupe_2.png`, createdAt: now, updatedAt: now },
  { id: 'p13', name: 'Düğün Küpe Seti', description: 'Düğün seti küpe, 18 ayar.', categoryId: 'cat6', variantId: 'v2', brandId: 'b3', unitId: 'u1', pricePerUnit: 15800, featured: true, imageUrl: `${AKBEN_IMG}/akben_kupe_3.png`, createdAt: now, updatedAt: now },
];
